									...
									{categories ? (
										categories.map((categories) => (
											<TableRow key={categories._id}>
												...
												{/* <TableCell align="right">{categories.username}</TableCell>
												<TableCell align="right">
													<Chip
														variant="outlined"
														color="secondary"
														label={categories.role}
													/>
												</TableCell>
												<TableCell align="right">
													{moment(categories.lastActive).format("llll")}
												</TableCell> */}


												<TableCell align="right">
												{/* <Link to={`${props.match.path}/update/${categories._id}`}>
														<EditIcon />
													</Link> */}
													<DeleteIcon onClick={() => handleDelete(categories._id)} />
												</TableCell>
											</TableRow>
										))
									) : (
